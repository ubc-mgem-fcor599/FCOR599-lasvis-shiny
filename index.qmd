...
![Tree detection in a Shiny app, try it yourself below!](images/itd_shiny.png){fig-align="center"}
...
2.  Open itd_shiny.R in RStudio and run entire script to start up the shiny app
3.  Load an example CHM (or your own) and play around
...
[![Mastering Shiny - Free textbook by Hadley Wickham](images/textbook.jpg){fig-align="center" width="250"}](https://mastering-shiny.org/)
...
[**Download the Rotating LAS GIF Script and sample data (.zip)**](rotating_las_gif.zip)
...
-   [Check out Potree Desktop](https://github.com/potree/PotreeDesktop) (not recommended for UBC laptops)

-   [Check out these Potree examples](https://github.com/potree/potree?tab=readme-ov-file#examples) (find a cool one for your assignment)
